        ...
        <div className="lg-w-full h-fit text-white mt-12 bg-mainbg font-Ubuntu">
            <section className="lg:w-[80%] mx-auto justify-items-center bg-primarybg border-r border-r-gray-700 border-l border-l-gray-700">
                ...
                <div className="w-full px-4 py-4 grid grid-cols-4 gap-6 text-gray-900">
                    <NavLink to=''
                    className="w-full text-center bg-white rounded-lg border border-gray-700 hover:text-hoverbdr hover:-translate-y-2 hover:rotate-y-22 hover:border-hoverbdr transition-all duration-400 dealy-75 hover:w-full ease-in-out"
                    >
                    ...
                    >
                        ...
                        <h2 className="lg:text-lg py-2">PUBG</h2>
                    </NavLink>
                    <NavLink to=''
                    className="w-full text-center bg-white rounded-lg border border-gray-700 hover:text-hoverbdr hover:-translate-y-2 hover:rotate-y-22 hover:border-hoverbdr transition-all duration-400 dealy-75 hover:w-full ease-in-out"
                    >
                    ...
                    >
                        <img className="w-full h-62 rounded-t-lg" src="/src/assets/image/free-fire.jpg" alt="" />
                        <h2 className="lg:text-lg py-2">STARFIELD</h2>
                    </NavLink>
                    <NavLink to=''
                    className="w-full text-center bg-white rounded-lg border border-gray-700 hover:text-hoverbdr hover:-translate-y-2 hover:rotate-y-22 hover:border-hoverbdr transition-all duration-400 dealy-75 hover:w-full ease-in-out"
                    >
